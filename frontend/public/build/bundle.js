...
var app = (function () {
	...
	const file$7 = "src/components/WalletCard.svelte";
	...
	function create_fragment$8(ctx) {
		...
		function select_block_type(ctx, dirty) {
			if (/*wallet*/ ctx[0].balance.eth) return create_if_block$4;
		...
		const block = {
			c: function create() {
				...
				t14 = space();
				t15 = text(t15_value);
				add_location(h3, file$7, 6, 8, 108);
				attr_dev(header, "class", "card-header svelte-f9j9lt");
				add_location(header, file$7, 5, 4, 71);
				add_location(strong0, file$7, 9, 11, 189);
				attr_dev(p0, "class", "svelte-f9j9lt");
				add_location(p0, file$7, 9, 8, 186);
				add_location(strong1, file$7, 11, 12, 257);
				attr_dev(p1, "class", "svelte-f9j9lt");
				add_location(p1, file$7, 10, 8, 241);
				add_location(strong2, file$7, 14, 11, 383);
				attr_dev(p2, "class", "svelte-f9j9lt");
				add_location(p2, file$7, 14, 8, 380);
				add_location(strong3, file$7, 15, 11, 444);
				attr_dev(p3, "class", "svelte-f9j9lt");
				add_location(p3, file$7, 15, 8, 441);
				attr_dev(section, "class", "card-body svelte-f9j9lt");
				add_location(section, file$7, 8, 4, 150);
				attr_dev(div, "class", "card svelte-f9j9lt");
				add_location(div, file$7, 4, 0, 48);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
	...
	class WalletCard extends SvelteComponentDev {
		constructor(options) {
			super(options);
			init(this, options, instance$8, create_fragment$8, safe_not_equal, { wallet: 0 });
	...
	const file$6 = "src/routes/wallet/index.svelte";
	...
	function create_fragment$7(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(h1, file$6, 30, 4, 971);
				add_location(p, file$6, 31, 4, 1001);
				attr_dev(div, "class", "wallets svelte-1o5ivwu");
				add_location(div, file$6, 33, 4, 1071);
				attr_dev(section, "class", "dashboard svelte-1o5ivwu");
				add_location(section, file$6, 29, 0, 939);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
	...
	const file$5 = "src/components/WalletForm.svelte";
	...
	function create_fragment$6(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(button, file$5, 12, 4, 236);
				attr_dev(div, "class", "wallet-form svelte-htre7s");
				add_location(div, file$5, 11, 0, 206);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
	...
	class WalletForm extends SvelteComponentDev {
		constructor(options) {
			super(options);
			init(this, options, instance$6, create_fragment$6, safe_not_equal, { onCreateWallet: 2 });
	...
	const file$4 = "src/routes/wallet/create.svelte";
	...
	function create_else_block$3(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(div, file$4, 36, 8, 1031);
			},
			m: function mount(target, anchor) {
				insert_dev(target, div, anchor);
	...
	function create_if_block$3(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(div, file$4, 32, 8, 931);
			},
			m: function mount(target, anchor) {
				insert_dev(target, div, anchor);
	...
	function create_fragment$5(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(h1, file$4, 28, 4, 803);
				attr_dev(p, "class", "svelte-v4c3pd");
				add_location(p, file$4, 29, 4, 832);
				attr_dev(section, "class", "create-wallet-container svelte-v4c3pd");
				add_location(section, file$4, 27, 0, 757);
			},
			l: function claim(nodes) {
	...
	const file$3 = "src/components/LoanRequestForm.svelte";
	...
	function create_if_block_5(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(h2, file$3, 93, 12, 3250);
				attr_dev(input0, "type", "number");
				attr_dev(input0, "placeholder", "Enter loan amount");
				input0.required = true;
				attr_dev(input0, "class", "svelte-1djcpp2");
				add_location(input0, file$3, 96, 16, 3358);
				attr_dev(label0, "class", "svelte-1djcpp2");
				add_location(label0, file$3, 94, 12, 3305);
				option.__value = "";
				set_input_value(option, option.__value);
				option.disabled = true;
				add_location(option, file$3, 107, 20, 3708);
	...
	function create_each_block_3(ctx) {
		...
		const block = {
			c: function create() {
				option = element("option");
				t = text(t_value);
				option.__value = /*token*/ ctx[30];
				set_input_value(option, option.__value);
				add_location(option, file$3, 109, 24, 3826);
			},
			m: function mount(target, anchor) {
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "each",
			source: "(109:20) {#each tokens as token}",
			ctx
		});
	...
	function create_if_block_4(ctx) {
		...
		const block = {
			c: function create() {
				...
				attr_dev(h2, "class", "svelte-1djcpp2");
				add_location(h2, file$3, 138, 12, 4590);
				attr_dev(input0, "type", "number");
				attr_dev(input0, "placeholder", "Enter your income");
				input0.required = true;
				attr_dev(input0, "class", "svelte-1djcpp2");
				add_location(input0, file$3, 141, 16, 4693);
				attr_dev(label0, "class", "svelte-1djcpp2");
				add_location(label0, file$3, 139, 12, 4637);
				option0.__value = "";
				set_input_value(option0, option0.__value);
				option0.disabled = true;
				add_location(option0, file$3, 152, 20, 5055);
				...
				add_location(select0, file$3, 151, 16, 4977);
				attr_dev(label1, "class", "svelte-1djcpp2");
				add_location(label1, file$3, 149, 12, 4920);
				attr_dev(input1, "type", "number");
				attr_dev(input1, "placeholder", "Enter your expense");
				input1.required = true;
				attr_dev(input1, "class", "svelte-1djcpp2");
				add_location(input1, file$3, 161, 16, 5377);
				attr_dev(label2, "class", "svelte-1djcpp2");
				add_location(label2, file$3, 159, 12, 5320);
				option1.__value = "";
				set_input_value(option1, option1.__value);
				option1.disabled = true;
				add_location(option1, file$3, 172, 20, 5743);
				...
				add_location(select1, file$3, 171, 16, 5664);
				attr_dev(label3, "class", "svelte-1djcpp2");
				add_location(label3, file$3, 169, 12, 5606);
				attr_dev(textarea, "placeholder", "Why do you need this loan?");
				textarea.required = true;
				attr_dev(textarea, "class", "svelte-1djcpp2");
				add_location(textarea, file$3, 181, 16, 6065);
				attr_dev(label4, "class", "svelte-1djcpp2");
				add_location(label4, file$3, 179, 12, 6008);
				attr_dev(div, "class", "form-step");
				add_location(div, file$3, 137, 8, 4554);
			},
			m: function mount(target, anchor) {
				insert_dev(target, div, anchor);
				append_dev(div, h2);
	...
	// (154:20) {#each fiatCurrencies as currency}
	function create_each_block_2(ctx) {
		let option;
		let t_value = /*currency*/ ctx[25] + "";
		let t;
		...
		const block = {
			c: function create() {
				option = element("option");
				t = text(t_value);
				option.__value = /*currency*/ ctx[25];
				set_input_value(option, option.__value);
				add_location(option, file$3, 154, 24, 5187);
			},
			m: function mount(target, anchor) {
				insert_dev(target, option, anchor);
				append_dev(option, t);
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "each",
			source: "(154:20) {#each fiatCurrencies as currency}",
			ctx
		});
	...
	// (174:20) {#each fiatCurrencies as currency}
	function create_each_block_1(ctx) {
		...
		const block = {
			c: function create() {
				...
				option.__value = /*currency*/ ctx[25];
				set_input_value(option, option.__value);
				add_location(option, file$3, 174, 24, 5875);
			},
			m: function mount(target, anchor) {
				insert_dev(target, option, anchor);
				append_dev(option, t);
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "each",
			source: "(174:20) {#each fiatCurrencies as currency}",
			ctx
		});
	...
	function create_if_block_2(ctx) {
		...
		const block = {
			c: function create() {
				...
				attr_dev(h2, "class", "svelte-1djcpp2");
				add_location(h2, file$3, 192, 12, 6367);
				option0.__value = "";
				set_input_value(option0, option0.__value);
				option0.disabled = true;
				add_location(option0, file$3, 196, 20, 6550);
				option1.__value = "crypto";
				set_input_value(option1, option1.__value);
				add_location(option1, file$3, 197, 20, 6619);
				option2.__value = "real-world";
				set_input_value(option2, option2.__value);
				add_location(option2, file$3, 198, 20, 6678);
				select0.required = true;
				attr_dev(select0, "class", "svelte-1djcpp2");
				if (/*loanDetails*/ ctx[1].collateralType === void 0) add_render_callback(() => /*select0_change_handler_1*/ ctx[18].call(select0));
				add_location(select0, file$3, 195, 16, 6472);
				attr_dev(label0, "class", "svelte-1djcpp2");
				add_location(label0, file$3, 193, 12, 6415);
				option3.__value = "";
				set_input_value(option3, option3.__value);
				option3.disabled = true;
				add_location(option3, file$3, 226, 20, 7569);
				select1.required = true;
				attr_dev(select1, "class", "svelte-1djcpp2");
				if (/*loanDetails*/ ctx[1].duration === void 0) add_render_callback(() => /*select1_change_handler_1*/ ctx[20].call(select1));
				add_location(select1, file$3, 225, 16, 7497);
				attr_dev(label1, "class", "svelte-1djcpp2");
				add_location(label1, file$3, 223, 12, 7442);
				attr_dev(div, "class", "form-step");
				add_location(div, file$3, 191, 8, 6331);
			},
			m: function mount(target, anchor) {
				insert_dev(target, div, anchor);
				append_dev(div, h2);
	...
	// (203:12) {#if loanDetails.collateralType === "real-world"}
	function create_if_block_3(ctx) {
		...
		const block = {
			c: function create() {
				...
				textarea.required = true;
				attr_dev(textarea, "class", "svelte-1djcpp2");
				add_location(textarea, file$3, 205, 16, 6915);
				attr_dev(label0, "class", "svelte-1djcpp2");
				add_location(label0, file$3, 203, 12, 6853);
				attr_dev(input, "type", "file");
				attr_dev(input, "accept", "image/*");
				input.required = true;
				attr_dev(input, "class", "svelte-1djcpp2");
				add_location(input, file$3, 214, 16, 7216);
				attr_dev(label1, "class", "svelte-1djcpp2");
				add_location(label1, file$3, 212, 12, 7162);
			},
			m: function mount(target, anchor) {
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "if",
			source: "(203:12) {#if loanDetails.collateralType === \\\"real-world\\\"}",
			ctx
		});
	...
	// (228:20) {#each durations as duration}
	function create_each_block(ctx) {
		let option;
		let t_value = /*duration*/ ctx[22] + "";
		let t;
		...
		const block = {
			c: function create() {
				option = element("option");
				t = text(t_value);
				option.__value = /*duration*/ ctx[22];
				set_input_value(option, option.__value);
				add_location(option, file$3, 228, 24, 7694);
			},
			m: function mount(target, anchor) {
				insert_dev(target, option, anchor);
				append_dev(option, t);
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "each",
			source: "(228:20) {#each durations as duration}",
			ctx
		});
	...
	function create_if_block_1$1(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(button, file$3, 237, 16, 7925);
			},
			m: function mount(target, anchor) {
	...
	function create_else_block$2(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(button, file$3, 243, 16, 8210);
			},
			m: function mount(target, anchor) {
				insert_dev(target, button, anchor);
	...
	function create_if_block$2(ctx) {
		...
		const block = {
			c: function create() {
				...
				attr_dev(button, "type", "button");
				attr_dev(button, "class", "btn btn-primary svelte-1djcpp2");
				add_location(button, file$3, 241, 16, 8088);
			},
			m: function mount(target, anchor) {
				insert_dev(target, button, anchor);
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "if",
			source: "(241:12) {#if step < totalSteps}",
			ctx
		});
	...
	function create_fragment$4(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(div0, file$3, 83, 8, 3014);
				attr_dev(div1, "class", "progress-bar svelte-1djcpp2");
				add_location(div1, file$3, 82, 4, 2979);
				attr_dev(h1, "class", "svelte-1djcpp2");
				add_location(h1, file$3, 89, 4, 3143);
				attr_dev(div2, "class", "form-navigation svelte-1djcpp2");
				add_location(div2, file$3, 235, 8, 7852);
				add_location(form, file$3, 90, 4, 3174);
				attr_dev(section, "class", "loan-form-container svelte-1djcpp2");
				add_location(section, file$3, 81, 0, 2937);
			},
			l: function claim(nodes) {
	...
	function instance$4($$self, $$props, $$invalidate) {
		...
		function handleSubmit() {
			return __awaiter(this, void 0, void 0, function* () {
				...
				try {
					const response = yield fetch(`${urlRoot}/api/v1/loans/`, {
						method: "POST",
						headers: { "Content-Type": "application/json" },
		...
		Object.keys($$props).forEach(key => {
			if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<LoanRequestForm> was created with unknown prop '${key}'`);
		});
	...
	const file$2 = "src/routes/loan/request.svelte";
	...
	function create_fragment$3(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(h1, file$2, 5, 4, 140);
				attr_dev(section, "class", "loan-request-container svelte-131hq4d");
				add_location(section, file$2, 4, 0, 95);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
	...
	function create_key_block(ctx) {
		...
		const block = {
			c: function create() {
				div = element("div");
				if (default_slot) default_slot.c();
				add_location(div, file$1, 135, 8, 4659);
			},
			m: function mount(target, anchor) {
				insert_dev(target, div, anchor);
	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(meta, file, 10, 2, 327);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
