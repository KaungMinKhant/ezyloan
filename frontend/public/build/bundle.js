...
var app = (function () {
	...
	function create_if_block_2$2(ctx) {
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "if",
			source: "(24:12) {#if wallet.balance.eth}",
			ctx
		});
	...
	function create_if_block_1$4(ctx) {
		...
		let strong0;
		let t3;
		let t4_value = /*wallet*/ ctx[0].loan_details.status + "";
		let t4;
		let t5;
		let p1;
		let strong1;
		let t7;
		let t8_value = /*wallet*/ ctx[0].loan_details.approved_loan_amount + "";
		let t8;
		let t9;
		let t10_value = /*wallet*/ ctx[0].loan_details.approved_loan_token + "";
		let t10;
		let t11;
		let p2;
		let strong2;
		let t13;
		let t14_value = /*wallet*/ ctx[0].loan_details.collateral_value_in_usd.toFixed(2) + "";
		let t14;
		let t15;
		let p3;
		let strong3;
		let t17;
		let t18_value = /*wallet*/ ctx[0].loan_details.max_loan_amount_in_usd.toFixed(2) + "";
		let t18;
		let t19;
		let p4;
		let strong4;
		let t21;
		let t22_value = /*wallet*/ ctx[0].loan_details.lender_wallet_id + "";
		let t22;
		let t23;
		let p5;
		let strong5;
		let t25;
		let t26_value = /*wallet*/ ctx[0].loan_details.smart_contract_address + "";
		let t26;
		let t27;
		let p6;
		let strong6;
		...
		let strong7;
		let t33;
		let t34_value = new Date(/*wallet*/ ctx[0].loan_details.timestamp).toLocaleString() + "";
		let t34;
		let t35;
		let button;

		let t36_value = (/*showRepayForm*/ ctx[1]
		? "Cancel Repayment"
		: "Repay Loan") + "";
		...
		const block = {
			c: function create() {
				...
				button = element("button");
				t36 = text(t36_value);
				attr_dev(h4, "class", "svelte-d4tpdt");
				add_location(h4, file$a, 31, 12, 881);
				add_location(strong0, file$a, 32, 15, 918);
				attr_dev(p0, "class", "svelte-d4tpdt");
				add_location(p0, file$a, 32, 12, 915);
				add_location(strong1, file$a, 33, 15, 991);
				attr_dev(p1, "class", "svelte-d4tpdt");
				add_location(p1, file$a, 33, 12, 988);
				add_location(strong2, file$a, 34, 15, 1125);
				attr_dev(p2, "class", "svelte-d4tpdt");
				add_location(p2, file$a, 34, 12, 1122);
				add_location(strong3, file$a, 35, 15, 1243);
				attr_dev(p3, "class", "svelte-d4tpdt");
				add_location(p3, file$a, 35, 12, 1240);
				add_location(strong4, file$a, 36, 15, 1359);
				attr_dev(p4, "class", "svelte-d4tpdt");
				add_location(p4, file$a, 36, 12, 1356);
				add_location(strong5, file$a, 37, 15, 1452);
				attr_dev(p5, "class", "svelte-d4tpdt");
				add_location(p5, file$a, 37, 12, 1449);
				add_location(strong6, file$a, 39, 16, 1574);
				attr_dev(a, "href", a_href_value = /*wallet*/ ctx[0].loan_details.transaction_link);
				attr_dev(a, "target", "_blank");
				attr_dev(a, "rel", "noopener noreferrer");
				attr_dev(a, "class", "svelte-d4tpdt");
				add_location(a, file$a, 40, 16, 1621);
				attr_dev(p6, "class", "svelte-d4tpdt");
				add_location(p6, file$a, 38, 12, 1554);
				add_location(strong7, file$a, 44, 15, 1803);
				attr_dev(p7, "class", "svelte-d4tpdt");
				add_location(p7, file$a, 44, 12, 1800);
				attr_dev(button, "class", "btn btn-repay svelte-d4tpdt");
				add_location(button, file$a, 45, 12, 1906);
				attr_dev(section, "class", "loan-details svelte-d4tpdt");
				add_location(section, file$a, 30, 8, 838);
			},
			m: function mount(target, anchor) {
				insert_dev(target, section, anchor);
				...
				if (!mounted) {
					dispose = listen_dev(button, "click", /*toggleRepayForm*/ ctx[2], false, false, false, false);
					mounted = true;
				}
			},
			p: function update(ctx, dirty) {
				if (dirty & /*wallet*/ 1 && t4_value !== (t4_value = /*wallet*/ ctx[0].loan_details.status + "")) set_data_dev(t4, t4_value);
				if (dirty & /*wallet*/ 1 && t8_value !== (t8_value = /*wallet*/ ctx[0].loan_details.approved_loan_amount + "")) set_data_dev(t8, t8_value);
				if (dirty & /*wallet*/ 1 && t10_value !== (t10_value = /*wallet*/ ctx[0].loan_details.approved_loan_token + "")) set_data_dev(t10, t10_value);
				if (dirty & /*wallet*/ 1 && t14_value !== (t14_value = /*wallet*/ ctx[0].loan_details.collateral_value_in_usd.toFixed(2) + "")) set_data_dev(t14, t14_value);
				if (dirty & /*wallet*/ 1 && t18_value !== (t18_value = /*wallet*/ ctx[0].loan_details.max_loan_amount_in_usd.toFixed(2) + "")) set_data_dev(t18, t18_value);
				if (dirty & /*wallet*/ 1 && t22_value !== (t22_value = /*wallet*/ ctx[0].loan_details.lender_wallet_id + "")) set_data_dev(t22, t22_value);
				if (dirty & /*wallet*/ 1 && t26_value !== (t26_value = /*wallet*/ ctx[0].loan_details.smart_contract_address + "")) set_data_dev(t26, t26_value);

				if (dirty & /*wallet*/ 1 && a_href_value !== (a_href_value = /*wallet*/ ctx[0].loan_details.transaction_link)) {
					attr_dev(a, "href", a_href_value);
				}

				if (dirty & /*wallet*/ 1 && t34_value !== (t34_value = new Date(/*wallet*/ ctx[0].loan_details.timestamp).toLocaleString() + "")) set_data_dev(t34, t34_value);

				if (dirty & /*showRepayForm*/ 2 && t36_value !== (t36_value = (/*showRepayForm*/ ctx[1]
				? "Cancel Repayment"
				: "Repay Loan") + "")) set_data_dev(t36, t36_value);
			},
			d: function destroy(detaching) {
				if (detaching) {
					detach_dev(section);
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "if",
			source: "(30:4) {#if wallet.loan_details}",
			ctx
		});
	...
	function create_if_block$6(ctx) {
		...
		loanrepayform = new LoanRepayForm({
				props: {
					...
					loan_details: /*wallet*/ ctx[0].loan_details
				},
				$$inline: true
			});
		...
		const block = {
			...
			p: function update(ctx, dirty) {
				...
				if (dirty & /*wallet*/ 1) loanrepayform_changes.loan_details = /*wallet*/ ctx[0].loan_details;
	...
	function create_fragment$b(ctx) {
		...
		let if_block1 = /*wallet*/ ctx[0].loan_details && create_if_block_1$4(ctx);
		let if_block2 = /*showRepayForm*/ ctx[1] && create_if_block$6(ctx);
		...
		const block = {
			c: function create() {
				...
				add_location(h3, file$a, 17, 8, 382);
				attr_dev(header, "class", "card-header svelte-d4tpdt");
				add_location(header, file$a, 16, 4, 345);
				add_location(strong0, file$a, 20, 11, 463);
				attr_dev(p0, "class", "svelte-d4tpdt");
				add_location(p0, file$a, 20, 8, 460);
				add_location(strong1, file$a, 22, 12, 531);
				attr_dev(p1, "class", "svelte-d4tpdt");
				add_location(p1, file$a, 21, 8, 515);
				add_location(strong2, file$a, 25, 11, 657);
				attr_dev(p2, "class", "svelte-d4tpdt");
				add_location(p2, file$a, 25, 8, 654);
				add_location(strong3, file$a, 26, 11, 718);
				attr_dev(p3, "class", "svelte-d4tpdt");
				add_location(p3, file$a, 26, 8, 715);
				attr_dev(section, "class", "card-body svelte-d4tpdt");
				add_location(section, file$a, 19, 4, 424);
				attr_dev(div, "class", "card svelte-d4tpdt");
				add_location(div, file$a, 15, 0, 322);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
			...
			p: function update(ctx, [dirty]) {
				...
				if (/*showRepayForm*/ ctx[1]) {
					if (if_block2) {
						if_block2.p(ctx, dirty);

						if (dirty & /*showRepayForm*/ 2) {
	...
	function instance$b($$self, $$props, $$invalidate) {
		...
		function toggleRepayForm() {
			...
			$$invalidate(1, showRepayForm = !showRepayForm);
		}
		...
		$$self.$inject_state = $$props => {
			if ('wallet' in $$props) $$invalidate(0, wallet = $$props.wallet);
			if ('showRepayForm' in $$props) $$invalidate(1, showRepayForm = $$props.showRepayForm);
		};
		...
		return [wallet, showRepayForm, toggleRepayForm];
	}
