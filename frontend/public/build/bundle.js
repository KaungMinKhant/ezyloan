...
var app = (function () {
	...
	function create_fragment$4(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(meta, file$3, 5, 4, 95);
				add_location(h1, file$3, 14, 4, 230);
				add_location(p, file$3, 15, 4, 262);
				add_location(main, file$3, 13, 0, 219);
			},
	...
	class Route extends SvelteComponentDev {
		constructor(options) {
			super(options);
			init(this, options, instance$3, create_fragment$3, safe_not_equal, { path: 6, component: 0 });
	...
	const file$1 = "src/routes/login/index.svelte";
	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				...
				attr_dev(meta, "name", "description");
				attr_dev(meta, "content", "Ezy loan provides loan.");
				add_location(meta, file, 10, 2, 331);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
