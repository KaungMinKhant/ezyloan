...
var app = (function () {
	...
	const file$5 = "src/components/WalletCard.svelte";
	...
	function create_fragment$6(ctx) {
		...
		function select_block_type(ctx, dirty) {
			if (/*wallet*/ ctx[0].balance.eth) return create_if_block$3;
		...
		const block = {
			c: function create() {
				...
				t14 = space();
				t15 = text(t15_value);
				add_location(h3, file$5, 6, 8, 108);
				attr_dev(header, "class", "card-header svelte-f9j9lt");
				add_location(header, file$5, 5, 4, 71);
				add_location(strong0, file$5, 9, 11, 189);
				attr_dev(p0, "class", "svelte-f9j9lt");
				add_location(p0, file$5, 9, 8, 186);
				add_location(strong1, file$5, 11, 12, 257);
				attr_dev(p1, "class", "svelte-f9j9lt");
				add_location(p1, file$5, 10, 8, 241);
				add_location(strong2, file$5, 14, 11, 383);
				attr_dev(p2, "class", "svelte-f9j9lt");
				add_location(p2, file$5, 14, 8, 380);
				add_location(strong3, file$5, 15, 11, 444);
				attr_dev(p3, "class", "svelte-f9j9lt");
				add_location(p3, file$5, 15, 8, 441);
				attr_dev(section, "class", "card-body svelte-f9j9lt");
				add_location(section, file$5, 8, 4, 150);
				attr_dev(div, "class", "card svelte-f9j9lt");
				add_location(div, file$5, 4, 0, 48);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
	...
	class WalletCard extends SvelteComponentDev {
		constructor(options) {
			super(options);
			init(this, options, instance$6, create_fragment$6, safe_not_equal, { wallet: 0 });
	...
	const file$4 = "src/routes/wallet/index.svelte";
	...
	function create_fragment$5(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(h1, file$4, 30, 4, 971);
				add_location(p, file$4, 31, 4, 1001);
				attr_dev(div, "class", "wallets svelte-1o5ivwu");
				add_location(div, file$4, 33, 4, 1071);
				attr_dev(section, "class", "dashboard svelte-1o5ivwu");
				add_location(section, file$4, 29, 0, 939);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
	...
	const file$3 = "src/components/WalletForm.svelte";
	...
	function create_fragment$4(ctx) {
		...
		const block = {
			...
			m: function mount(target, anchor) {
				...
				if (!mounted) {
					dispose = listen_dev(button, "click", /*handleCreateWallet*/ ctx[1], false);
					mounted = true;
				}
			},
			p: function update(ctx, [dirty]) {
	...
	class WalletForm extends SvelteComponentDev {
		constructor(options) {
			super(options);
			init(this, options, instance$4, create_fragment$4, safe_not_equal, { onCreateWallet: 2 });
	...
	const file$2 = "src/routes/wallet/create.svelte";
	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(meta, file, 9, 2, 269);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
